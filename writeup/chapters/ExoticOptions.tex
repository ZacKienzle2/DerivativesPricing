...
\begin{prop}{The Price Of The Lookback Put Option}{LookbackPutPrice}
	...
	\end{align}
	where \(\tau = T-t\), and \(d_{1,2}(\cdot, \cdot)\) correspond to the definitions in \cref{eq:D1Definition,eq:D2Definition} with the fixed strike \(K\) replaced by the running maximum \(M_0^t\) (or \(S_t\) where arguments are inverted).
\end{prop}
