...
\tcbuselibrary{skins, breakable, theorems, listings} % Add 'breakable' to this list
...
\titleformat{\section}
{\singlespacing\color{darkblue}\normalfont\Large\bfseries} % Added \singlespacing
{\thesection}
{1em}
{}
\titlespacing*{\section}{0pt}{1.5ex plus 1ex minus .2ex}{1ex plus .2ex} % Reduced from 3.5ex
...
{1em}
{}
\titlespacing*{\subsection}{0pt}{1.5ex plus 1ex minus .2ex}{0.8ex plus .2ex} % Reduced from 3.25ex

\titleformat{\subsubsection}
{\singlespacing\color{darkblue}\normalfont\normalsize\bfseries} % Added \singlespacing
{\thesubsubsection}
{1em}
{}
...
\newcommand{\query}[1]{%
	\marginpar{%
		\vspace*{5pt}%
		\fbox{\parbox{0.9\marginparwidth}{%
				\scriptsize\sffamily\raggedright%
				\textcolor{red}{\textbf{AQ:}} #1%
			}}%
	}%
}
...
\newcommand{\mnote}[2]{%
	\marginnote{%
		...
		\raggedright%
		\textcolor{airforceblue}{\textbf{#1}}\\[2pt] % The "Name"
		\color{black!85} #2 % The "Description" (Dark grey for contrast)
	}[0cm]%
}
