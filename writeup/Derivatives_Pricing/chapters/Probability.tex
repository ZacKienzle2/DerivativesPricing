...
Usually, the most convenient way to describe quantities of interest connected with random experiments is by using random variables.
...
The expectation of a (numerical) random variable is a weighted average of all the values that the random variable can take.
...
Expectations are used in many probabilistic analyses.
...
\subsection{Information and Indepedence}
