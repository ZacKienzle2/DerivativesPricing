...
\end{equation}
In modelling the stock price, we will separate the capital gains process from the impact of dividend payments. The capital gains process $G$ is assumed to follow the usual stochastic differential equation \citep{heath_ex-dividend_1988}.
\begin{equation}
...
\begin{prop}{Valuation with Deterministic Dividends}{ValuationDividendsModelOne}
	...
	\end{equation}
	where $I_t$ is given by expression \Cref{eq:CompoundedValueDividends}, and
	\begin{equation}
